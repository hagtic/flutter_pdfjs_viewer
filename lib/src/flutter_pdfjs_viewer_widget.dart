...
class PDFJSViewerWidget extends StatefulWidget {
  ...
  factory PDFJSViewerWidget.data(Uint8List data,
      [bool clearCache = true, Key? key]) {
    return PDFJSViewerWidget._(
      fileData: data,
  ...
  factory PDFJSViewerWidget.network(String url,
      [bool clearCache = true, Key? key]) {
    return PDFJSViewerWidget._(
      filePath: url,
      clearCache: clearCache,
  ...
  factory PDFJSViewerWidget.file(String absolutePath,
      [bool clearCache = true, Key? key]) {
    return PDFJSViewerWidget._(
  ...
  factory PDFJSViewerWidget.assets(String asset,
      [bool clearCache = true, Key? key]) {
    return PDFJSViewerWidget._(
      filePath: asset,
      isAssets: true,
  ...
  Route _serveFlutterAssets(
    ...
    route = Route.get(path, (ctx) async {
      ...
      final body = (await rootBundle
              .load('packages/flutter_pdfjs_viewer/assets/$prefix$lookupPath'))
          .buffer
          .asUint8List();
